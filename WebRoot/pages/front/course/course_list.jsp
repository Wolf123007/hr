...
String updatePreUrl = basePath + "pages/front/course/CourseServletFront/updatePre";
String listDetailsUrl = basePath + "pages/front/course/DetailsServletFront/list";
%>
		  				...
		  				<c:if test="${ allCourses != null }" var="res">
		  					<c:forEach items="${ allCourses }" var="course">
		  						<tr onmouseover="changeColor(this, 'white')" onmouseout="changeColor(this, '#f2f2f2')">
				  					...
				  					<td><a href="<%=updatePreUrl%>?course.cid=${course.cid}">修改</a></td>
