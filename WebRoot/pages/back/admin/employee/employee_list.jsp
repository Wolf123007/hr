...
String listCourseUrl = basePath + "pages/back/admin/course/CourseServletBack/listEmp";
%>
		  				...
		  				<c:if test="${ allEmployees != null }" var="res">
		  					<c:forEach items="${ allEmployees }" var="employee">
		  						<tr onmouseover="changeColor(this, 'white')" onmouseout="changeColor(this, '#f2f2f2')">
				  					...
				  					<td><a href="<%= listCourseUrl %>?employee.eid=${employee.eid}">培训记录</a></td>
				  				</tr>
		  					</c:forEach>
		  				</c:if>
		  			</table>
